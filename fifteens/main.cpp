...
//	vector<int> f_start = { 5, 1, 0, 3, 7, 10, 2, 4, 9, 8, 6, 12, 13, 14, 11, 15 };	//+ 18 steps

//	vector<int> f_start = { 10, 6, 4, 13, 8, 11, 3, 9, 1, 5, 14, 12, 0, 2, 15, 7 }; //+ 51 steps
//	vector<int> f_start = { 15, 4, 12, 9, 3, 11, 1, 14, 13, 7, 5, 8, 0, 6, 10, 2 };
//	vector<int> f_start = { 3, 12, 6, 10, 14, 13, 5, 1, 15, 2, 11, 9, 0, 7, 8, 4 };

//	vector<int> f_start = { 5, 1, 7, 4, 0, 13, 6, 12, 9, 3, 10, 2, 14, 8, 11, 15 };
//	vector<int> f_start = { 0, 2, 4, 8, 1, 10, 6, 3, 5, 14, 7, 11, 9, 13, 15, 12 };

//	vector<int> f_start = { 1, 4, 3, 2, 5, 6, 12, 8, 9, 10, 11, 7, 13, 14, 15, 0 };
